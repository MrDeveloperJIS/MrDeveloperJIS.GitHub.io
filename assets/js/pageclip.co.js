! function (e) {
    var t = function () {},
        s = {
            ...
            form: function (t, n) {
                if (n = n || {}, null == t) throw new Error("form() must be passed an HTMLFormElement or String, not null");
                if ("string" == typeof t && (t = document.querySelector(t)), e.jQuery && t instanceof e.jQuery && (t = t[0]), !(t instanceof e.HTMLFormElement)) throw new Error("form() must be passed an HTMLFormElement or String");
                var r = o(t.getAttribute("action")),
                    ...
                    m = new i(t);
                t.classList.add(c), t.onsubmit = function (e) {
                    e.preventDefault(), m.start();
                    var o = JSON.stringify(s.formToJSON(t)),
                        i = !1 !== (!n.onSubmit || n.onSubmit());
                    i && (t.classList.add(u), s._showSubmitting(t), s._send(r.key, r.url, a, o, n, function (e, r) {
                        i && s._hideSubmitting(t), t.classList.remove(u), t.classList.add(e ? l : d), !1 !== (!n.onResponse || n.onResponse(e, r)) && !e && s._showSuccess(t, f), e ? console.error(e.message || e) : t.reset(), setTimeout(function () {
                            m.stop()
                        }, 200)
                    }))
                }
            ...
            _xhrFetch: function (n, r, o, i, a) {
                ...
                o = function (e, t) {
                    ...
                    "X-REQTRANSPORT": "xhr",
                    "X-HASFETCH": !!e.fetch
                }, o), a = a || t, c.onreadystatechange = function () {
                    try {
                        if (4 === c.readyState) {
                            var e = c.response,
                                t = 200 === c.status ? null : new Error("Error submitting data: " + (e ? e.error : "Unknown Error"));
                            a(t, t ? null : e)
                        }
                    } catch (t) {
                        s._sendError(n, t), a(t)
                    }
                }, c.open("POST", r), c.responseType = "json";
            ...
            _sendError: function (e, t) {
                var n = '{"error": "' + (t.stack || t.message || t + "").replace(/"/g, '\\"').replace(/\n/g, "\\n") + '"}',
                    r = s._xhr();
                r.open("POST", s._base + "/error/" + (e || "")), r.setRequestHeader("Content-Type", "application/json"), r.setRequestHeader("X-REQMETHOD", "send-v1"), r.send(n)
            },
            ...
            _showSuccess: function (e, t) {
                ...
                n.classList.add(s.cssBase + "__success"), n.innerHTML = t, n.onclick = function () {
                    s._hideSuccess(e)
                }, e.appendChild(n)
            },
    ...
    i.prototype.start = function () {
        if (this.el) {
            ...
            e.remove(l), e.remove(u), e.add(c), d(this.el, function () {
                e.remove(c), e.add(u)
            }, function () {
                e.add(u), e.remove(c)
            })
    ...
    var f = null;
    "undefined" != typeof module && void 0 !== module.exports ? (module.exports = s, module.exports.normalizeAction = o) : (window.Pageclip = s, function () {
        for (var e = document.querySelectorAll("." + s.cssBase), t = 0; t < e.length; t++) s.form(e[t])
    }())
}(this || window || global);