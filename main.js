...
document.querySelector(".welcomeMenu").addEventListener("click", function () {
	document.getElementById("navbar").style.height = "0%";
});
...
document.querySelector(".educationsMenu").addEventListener("click", function () {
	document.getElementById("navbar").style.height = "0%";
});
...
document.querySelector(".certificationsMenu").addEventListener("click", function () {
	document.getElementById("navbar").style.height = "0%";
});
...
document.querySelector(".projectsMenu").addEventListener("click", function () {
	document.getElementById("navbar").style.height = "0%";
});
